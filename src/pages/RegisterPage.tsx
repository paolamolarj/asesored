      ...
      <div className="auth-panel">
        ...
        <div
          ...
          style={{
            width: 60,
            height: 60,
            background: "linear-gradient(135deg,var(--rose),#ff9f9f)",
            bottom: "20%",
            left: "10%",
            animationDelay: "1s",
            opacity: 0.3,
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: 360 }}>
          ...
          <h1
            className="syne anim-fade-up d1"
            style={{ fontSize: 38, fontWeight: 800, lineHeight: 1.15, marginBottom: 16 }}
          >
          ...
          <p
            ...
            style={{ color: "var(--text-muted)", fontSize: 16, lineHeight: 1.6, marginBottom: 36 }}
          >
            Crea tu cuenta en minutos y empieza a conectar con asesores y estudiantes de tu
            institución.
          </p>
              ...
              <div key={s} style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div
                  style={{
                    ...
                    background:
                      step >= s
                        ? "linear-gradient(135deg,var(--teal),#00a88b)"
                        : "rgba(255,255,255,.08)",
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                  <div className="input-wrap">
                    ...
                    <select
                      ...
                      value={form.carrera}
                      onChange={(e) => upd("carrera", e.target.value)}
                    >
                    ...
                    {[
                      ...
                      <label
                        ...
                        style={{
                          ...
                          background:
                            form.rol === r.v ? "rgba(0,201,167,.1)" : "var(--glass)",
                      ...
                      >
                        <input
                          ...
                          value={r.v}
                          style={{ display: "none" }}
                          checked={form.rol === r.v}
                          onChange={() => upd("rol", r.v)}
                        />
                        {r.l}
                      </label>
                    ))}
